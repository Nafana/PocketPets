...
public final class ChickenPet extends Pet {

    private final static String petIdentifier = "chickenpet";    // PetID, this should never be changed.
    ...
    public ChickenPet () {
        ...
        levelUpMultiplier = PocketPetsPlugin.getInstance().getConfig().getDouble("pets." + petIdentifier + ".levelupmiltiplier");
    ...
    public void useAbility (Player player) {
        ...
        player.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, activeAbilityTimer * 20, 1));
